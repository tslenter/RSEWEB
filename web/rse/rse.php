            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <form onclick=="return false" methode="get" class="form" autocomplete="off">
                       ...
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                       <label><input type="text" placeholder="Search.." name="qe" id='txtquery' onkeyup='saveValue(this);' pattern="[A-Za-z0-9!@#$%^&*_=+-_.()'{};:\\ ]{0,45}" title="Only 45 characters allowed, some special characters are disabled ..."></label>
